...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=CatNap Demo Installer\n"
      else:
        line="OutputBaseFilename=CatNap Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the CatNap Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the CatNap installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=CatNap Demo installer\n"
     else:
       line="SetupWindowTitle=CatNap installer\n"
